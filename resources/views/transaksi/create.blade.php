            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="md:col-span-2">
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
                        <div class="px-6 py-5 border-b border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/50">
                            <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-100"><i class="fas fa-file-invoice-dollar text-[#76C3FC] mr-2"></i> Detail Transaksi</h3>
                        </div>
                        <div class="p-6">
                ...
                <div class="md:col-span-1">
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden sticky top-6">
                        <div class="px-6 py-5 border-b border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/50">
                            <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-100"><i class="fas fa-folder-plus text-[#F4A261] mr-2"></i> Kategori Baru</h3>
                        </div>
                        <div class="p-6">
                            <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">Buat kategori baru untuk mengelompokkan transaksi Anda (mis: Makanan, Gaji, Transport).</p>
                            ...
                            <form action="{{ route('kategori.store') }}" method="POST" class="space-y-4">
                                ...
                                <div>
                                    <div class="relative">
                                        ...
                                        <input type="text" name="nama" class="pl-10 block w-full rounded-xl border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-100 shadow-sm focus:border-[#76C3FC] focus:ring focus:ring-[#76C3FC] focus:ring-opacity-50 transition-colors py-2.5" placeholder="Nama Kategori" required>
                                    </div>
                                </div>
                                <button type="submit" class="w-full flex justify-center py-2.5 px-4 border border-transparent rounded-xl shadow-sm text-sm font-semibold text-white bg-gray-800 dark:bg-gray-600 hover:bg-gray-900 dark:hover:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors">
                                    Tambah Kategori
                                </button>
                            </form>
                        </div>
